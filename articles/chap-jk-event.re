...
コロナ禍の状況下ではオフライン開催が難しい情勢にありましたが、新しいオンラインカンファレンスが生まれ続けており、変化のなかで新しい機会を生み出しているのも、アジャイルな人たちの特長だと感じます。
2023年以降はオンライン・オフラインをあわせ持つハイブリッド開催が多くみられるようになったり、セッション動画がオンラインで公開されるケースも増えてきており、学びの手段や共有される文化に変化が現れています。

〓表番号〓に、20年前から続いているものからこれから誕生予定のものまで、カンファレンスの名称と公式ページへのリンクを並べてみました。知っているものがいくつあるか確認してみたり、イベントの雰囲気を見たり、次回イベントの情報を確認したりと、これからの参考に活用してみてください。
...
|Lean Conference Japan|2022|@<href>{https://lean-conference.com/, https://lean-conference.com/}<br>「日本"式"の理想的経営を考える」トヨタ生産方式から生まれ世界中に影響を与えているLeanを日本からどう向き合っていくかを考える場として誕生した。|

==== スクラムフェス一覧2024

年々増加しているスクラムフェス（通称スクフェス）をまとめてみました。
各地域で縁のあるメンバーを中心に企画されており、それぞれに特色のある運営にも注目です。
...
|Scrum Fest Okinawa|2022|@<href>{https://www.scrumfestokinawa.org/, https://www.scrumfestokinawa.org/}<br>キーノートもプロポーザルもないスクラムフェス。普段試せないアイディアを仲間たちと。|
|Scrum Fest Kanagawa|2023|@<href>{https://www.scrumfestkanagawa.org/, https://www.scrumfestkanagawa.org/}<br>初回は渋谷で開催されたスクフェス神奈川。速やかに立ち上がり、2024は2回開催。型にとらわれない柔軟な運営が新しい可能性を開拓中。|
|Scrum Fest Niseko|2023|@<href>{https://www.scrumfestsapporo.org/, https://www.scrumfestsapporo.org/}<br>アジャイル札幌が新しい挑戦。夏のニセコは素敵な体験が待っている。|
|Scrum Fest Kanazawa|2024|@<href>{https://www.scrumfestkanazawa.org/, https://www.scrumfestkanazawa.org/}<br>ずっとアジャイルと向き合ってきた金沢でついにスクフェスが誕生。復興支援の一助の目的も含まれたかたちで開催された。|

== よいカンファレンスに出会うということ
「よい」の定義はさまざまですが、筆者自身がよいと感じたカンファレンスは、さまざまな出会いがありました。
例えば、サーバントリーダーシップという言葉にはじめて出会ったのも、日本にいたら絶対に会えないような海外のスピーカーの話を聞けたのも、社内で悩んでいることを相談できる社外の仲間と出会えたのも、一緒にカンファレンスを運営してくれる・したいと思える仲間と出会えたのも、新しい職場を見つけたのも、すべてカンファレンスをきっかけとして起こった出会いでした。

よい出会いは、必ず自分の人生を変えてくれました。
ひとつひとつの出会いがなければ、まちがいなく今の自分はいませんでした。
本書に携わることができたのも、コミュニティからの出会いのおかげでした。

同じカンファレンスに通うと、1年越しの再会に感動することもしばしば。
お互いがお互いの場所で取り組んできたことを持ち寄って、また新しい元気や勇気をもらえるのもカンファレンスの魅力です。

== ほかにもたくさんあります

カンファレンス以外にも、さまざまなイベントやコミュニティなどもあります。
はじめはみんな知り合いがいない状態からスタートですが、その一歩を知っている人たちだからこそ、暖かく歓迎してくれる人たちがそこにはいます。
情報は各イベントのプラットフォームやX（旧Twitter）アカウントなどをフォローするのがおすすめです。
ステキなイベント、コミュニティ、そして人との出会いに巡り合えますように！
...
//embed{
    ...
    \begin{minipage}{.89\linewidth}
        J.K @project\_J\_K https://twitter.com/project\_J\_K\\
        Agile Tech EXPO Organizer / Agile Japan実行委員
        \end{minipage}
    \hspace{1ex}
//}
